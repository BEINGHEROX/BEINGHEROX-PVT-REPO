    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("🔥HEROX🔥 AARHA BHAG JA BSDK NHI TOH TERE MAA BHEN KA RAPE KRLEGA")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("🔥HEROX🔥 AARHA BHAG JA BSDK NHI TOH PRIVATE ME TERE MAA BHEN KA RAPE KRLEGA")
            except Exception as e:
                await event.edit(str(e))
        else:
            await e.reply(usage, parse_mode=None, link_preview=None)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("AB TU CHUD GYA AB TATA PHIRSE AYUGA")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "PHATE HUE CONDOM KI AULAD AB BOL"
            ...
            appendable = [g]
            qeue.append(appendable)
            text = "𝔸𝔹 𝔹𝕆𝕃 𝔹𝕊𝔻𝕂 𝕂𝔼 KALAP GYA HEROX BAAP THA , BAAP HA , BAAP RHEGA "
            await e.reply(text, parse_mode=None, link_preview=None)
        else:
            await e.reply(usage, parse_mode=None, link_preview=None)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "HEROX PAPA NE CHOD DIA ABB MJE KAR"
            await e.reply(text, parse_mode=None, link_preview=None)
        else:
            await e.reply(usage, parse_mode=None, link_preview=None)
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🔥 ʜᴇʀᴏx ᴏᴘ 🔥.!\n`{ms}` ms\n ʜᴇʀᴏx sᴘᴀᴍʙᴏᴛ ɪs ᴀʟɪᴠᴇ")
...
async def restart(e):
    if e.sender_id in SMEX_USERS:
        text = "WAIT ND WATCH TERI MAA CHODNE AARHA"
        await e.reply(text, parse_mode=None, link_preview=None)
        try:
...
async def help(e):
    if e.sender_id in SMEX_USERS:
        text = "[  ]\n\n𝐒𝐓𝐀𝐑𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.ping\n.restart\n\n𝐉𝐎𝐈𝐍 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.join\n.pjoin\n.leave\n\n𝐒𝐏𝐀𝐌 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.spam\n.delayspam\n.raid\n.bigspam\n.replyraid\n.dreplyraid\n\n𝐒𝐂𝐑𝐀𝐏 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.scrap\n\n𝐅𝐎𝐑 𝐍𝐄𝐄𝐃 𝐀𝐍𝐘 𝐇𝐄𝐋𝐏 𝐀𝐁𝐎𝐔𝐓 𝐒𝐏𝐀𝐌𝐁𝐎𝐓 𝐉𝐎𝐈𝐍 @TEAM_DOMINATORCHAT "
        await e.reply(text, parse_mode=None, link_preview=None)
